...
public class LiveInfoDao extends AbstractDao<LiveInfo, String> {
    ...
    public static class Properties {
        ...
        public final static Property Love_cover = new Property(35, String.class, "love_cover", false, "LOVE_COVER");
    }
    ...
    public LiveInfo readEntity(Cursor cursor, int offset) {
        LiveInfo entity = new LiveInfo( //
            ...
            cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35) // love_cover
        );
        return entity;
    }
    ...
    @Override
    protected final String updateKeyAfterInsert(LiveInfo entity, long rowId) {
        return entity.getNo();
    }
    
    @Override
    public String getKey(LiveInfo entity) {
        if(entity != null) {
            return entity.getNo();
        } else {
            return null;

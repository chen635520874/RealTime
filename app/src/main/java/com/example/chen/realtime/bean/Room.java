...
public class Room {
    ...
    private LiveBean live;//LiveBean
    ...
    private GirlRankBean girl_rank;//GirlRankBean
    private List<?> admins;
    private List<?> notice;
     ...
     * v : 1
     */
    private List<RoomLine> room_lines;//RoomLine
    ...
    private List<RankCurrBean> rank_curr;//RankCurrBean
...
//        }
    ...
    public static class GirlRankBean{
        ...
        /**
         *  girl_rank :{"curAnchorInfo : {"avatar":"http://image.quanmin.tv/avatar/ad569547dfe896f22a7bc5b1d4ecd3d5gif?imageView2/2/w/300/","nick":"浏阳河长的像猴子","uid":326745,"no":326745,"votes":2430,"rank":43,"toPre":0,"rankType":"GAME"}
         *
         * avatar : http://image.quanmin.tv/avatar/ad569547dfe896f22a7bc5b1d4ecd3d5gif?imageView2/2/w/300/
         * nick : 浏阳河长的像猴子
         * uid : 326745
         ...
         * rankType : GAME
         */
        private CurAnchorInfoBean curAnchorInfo;//CurAnchorInfoBean
